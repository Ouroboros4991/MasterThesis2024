...
from agents.option_critic_multi_discrete import OptionCriticMultiDiscrete
...
from utils.experience_replay import OptionRewardReplayBuffer, ReplayBuffer
...
def run(args):
    experiment_name = f"{args.agent}_{args.num_options}_options_{args.traffic}"
    if args.hd_reg:
