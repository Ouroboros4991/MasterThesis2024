...
def run(args):
    ...
    experiment_name = f"{args.agent}_classification_{args.num_options}_options_{TRAFFIC}"
    if args.hd_reg:
    ...
    for episode in range(num_episodes):
        ...
        while not done:
            ...
            actor_loss, critic_loss = option_critic.calculate_loss(state, option_critic.current_option, logp, entropy, reward, done, next_state, args)
